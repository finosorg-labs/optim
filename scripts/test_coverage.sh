...
if [ ! -f "$BUILD_DIR/tests/optim_tests" ]; then
    echo "Error: Test binary not found at $BUILD_DIR/tests/optim_tests"
    ...
    echo "  cmake --build $BUILD_DIR --target optim_tests"
    exit 1
fi
...
echo ""
echo "============================================================"
echo "Coverage Report - optim Module"
echo "============================================================"
echo ""
